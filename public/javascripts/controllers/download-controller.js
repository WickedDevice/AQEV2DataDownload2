angular.module('MyApp')
  .controller('DownloadController', ["$scope", "$interval", "$http", function($scope, $interval, $http){
    ...
    $scope.onDownloadClick = function(){
      ...
      if(requested_duration_in_hours > 1460){
        alert("Please request no more than 1460 hours (2 months) of data at a time. You asked for " + Math.ceil(requested_duration_in_hours) + " hours." );
        return;
      }
